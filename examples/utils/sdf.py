...
# DISCLAIMER: this is from GPT!


def mesh_sdf_on_grid(mesh, resolution=(64, 64, 64), padding=0.1):
    """
...
if __name__ == "__main__":
    ...
    sdf_grid, _, _ = mesh_sdf_on_grid(mesh, resolution=[args.resolution] * 3)
    np.save(args.output, sdf_grid)
